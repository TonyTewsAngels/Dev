...
*/
	...
	public void start(Stage primaryStage) throws Exception {
		...
		textFragList.add(new TextHandlerObject.TextFragmentBuilder("Hello World!").build());
		
		textHandler.createTextbox(new TextHandlerObject.TextBoxBuilder(100, 200).textFragmentList(textFragList).build());
